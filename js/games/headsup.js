export const DECKS = [
  {
    id: 'famous',
    name: 'Famous Faces',
    subtitle: 'Celebrities, Icons & Legends',
    emoji: '⭐',
    age: 'all', difficulty: 'medium',
    bg: 'linear-gradient(160deg,#1a1500,#3a2c00)',
    accent: '#ffe600',
  ...
  },
  {
    id: 'movies',
    name: 'Movies & TV',
    subtitle: 'Blockbusters, Shows & Classics',
    emoji: '🎬',
    age: 'all', difficulty: 'medium',
    bg: 'linear-gradient(160deg,#1a0010,#3a0025)',
    accent: '#ff2d78',
  ...
  },
  {
    id: 'animals',
    name: 'Animals',
    subtitle: 'Wild Creatures & Nature',
    emoji: '🦁',
    age: 'all', difficulty: 'easy',
    bg: 'linear-gradient(160deg,#1a0c00,#3a1800)',
    accent: '#ff7a30',
  ...
  },
  {
    id: 'places',
    name: 'Places',
    subtitle: 'Landmarks & Destinations',
    emoji: '🗺️',
    age: 'all', difficulty: 'hard',
    bg: 'linear-gradient(160deg,#001620,#002840)',
    accent: '#00d4ff',
  ...
  },
  {
    id: 'actions',
    name: 'Act It Out',
    subtitle: 'Charades Vibes & Movement',
    emoji: '🎭',
    age: 'all', difficulty: 'easy',
    bg: 'linear-gradient(160deg,#100018,#220030)',
    accent: '#b060ff',
    border: 'rgba(176,96,255,0.3)',
    cards: [
  ...
  },
  {
    id: 'food',
    name: 'Food & Drinks',
    subtitle: 'From Fork to Fridge',
    emoji: '🍕',
    age: 'all', difficulty: 'easy',
    bg: 'linear-gradient(160deg,#001808,#002e14)',
    accent: '#00e87a',
